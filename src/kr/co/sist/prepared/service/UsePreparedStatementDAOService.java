...
import kr.co.sist.dao.CpEmp4VO;
import kr.co.sist.dao.PreparedStatementDAO;
...
public class UsePreparedStatementDAOService {
	...
	public void addCpEmp4() {
		...
		try {
			...
			JOptionPane.showMessageDialog(null, ceVO.getEname()+"의 사원정보를 추가하였습니다.");
	...
	public void modifyCpEmp4() {
		...
		//3.DB작업 후 결과 얻기
		int cnt=psDAO.updateCpEmp4(ceVO);//update작업 후 변경된 행의 개수 얻기
	...
	public void searchOneCpEmp4() {
		...
		try {
			...
			int empno=Integer.parseInt( tempData );
			//DB작업
			CpEmp4VO ceVO=psDAO.selectOneCpEmp4(empno);//사원번호에 대한 사원 하나 조회
